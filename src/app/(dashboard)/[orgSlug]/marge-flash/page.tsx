...
import { MargeDashboard } from './components/marge-dashboard'

export async function generateMetadata() {
  return { title: 'Marge Flash — AgroPilot.IA' }
}

export default async function MargeFlashPage({
  params,
}: {
  ...
  return (
    <div>
      ...
      <MargeDashboard orgSlug={orgSlug} />
    </div>
  )
}
