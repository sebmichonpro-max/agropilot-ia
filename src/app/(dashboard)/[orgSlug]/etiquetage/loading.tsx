...
export default function EtiquetageLoading() {
  return (
    <div className="space-y-6">
      <div>
        <div className="h-8 w-40 rounded bg-ap-cream-200 animate-pulse" />
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <Card key={i} className="border-ap-cream-200 rounded-xl">
            <CardContent className="p-4 space-y-3">
              ...
              <div className="h-4 w-1/2 rounded bg-ap-cream-200 animate-pulse" />
            </CardContent>
          </Card>
        ))}
      </div>
